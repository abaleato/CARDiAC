...
CARDiAC is a python code to compute the impact of anisotropic redshift distributions on a wide class of angular
...
-galaxy lensing. The anisotropy can be present in the mean redshift and/or width of redshift distributions, as
